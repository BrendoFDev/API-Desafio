...
A API deverá retornar respostas HTTP adequadas para situações como:

* Dados inválidos;
* Recurso inexistente;
* Tentativa de remover um carro que possui reserva;
* Tentativa de remover um cliente que possui reserva;
* Cliente inexistente ao criar uma reserva;
* Carro inexistente ao criar uma reserva;
* Erros inesperados.

As mensagens de erro devem ser claras o suficiente para que o consumidor da API consiga entender o problema.

---

# Documentação

O projeto deverá possuir alguma forma de documentação dos endpoints disponibilizados.

Pode ser utilizada qualquer ferramenta ou abordagem adequada.

A documentação deverá permitir que outra pessoa consiga entender:

* Quais endpoints existem;
* Quais parâmetros devem ser enviados;
* Qual o formato das requisições;
* Qual o formato das respostas;
...
A criação de testes automatizados não é obrigatória, porém será considerada um diferencial na avaliação.
...
É especialmente interessante testar as regras que impedem a exclusão de carros e clientes que possuem reservas.

---

# Diferenciais

Os seguintes itens não são obrigatórios, mas poderão ser considerados como diferenciais:
...
* Migrations;
* Logs estruturados;
* Validação utilizando uma biblioteca específica;
...
* README com instruções detalhadas para execução.
